...
All 3 commands in `.cursor/commands/` (mirrored in `.claude/commands/`) were
...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/add-action`    | Add a `task/cleared` action ("clearTasks" — empties the task list)                                                                                                       | Added the `Action` variant, reducer `case`, `clearTasks()` creator, and 2 colocated tests (happy path + already-empty edge case), following the golden path from `.cursor/rules/architecture.mdc` | `app/src/types.ts`, `app/src/reducer.ts`, `app/src/actions.ts`, `app/src/reducer.test.ts` | `npm test`: 17/17 ✅ · `npm run typecheck`: clean ✅                                                                                                                                          |
